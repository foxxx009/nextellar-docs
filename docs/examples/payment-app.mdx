...
[View Live Demo](https://stellar-payment-demo.vercel.app) (Coming soon)
...
src/
  ...
  components/
    ...
    TransactionHistoryList.tsx   # Transaction list
    ReceiveQRCode.tsx           # QR code for receiving
  hooks/
    useStellarWallet.ts         # Wallet management
    useStellarPayment.ts        # Payment handling
    useTransactionHistory.ts    # Transaction queries
  lib/
        ...
        {connected ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <BalanceSummary balances={balances} publicKey={publicKey} />
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                {activeTab === 'history' && (
                  <TransactionHistoryList publicKey={publicKey} />
                )}
              </div>
            </div>
          </div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  ...
  >
    ...
    <span className="text-sm text-muted-foreground block">Build an NFT marketplace on Stellar</span>
  </a>
  ...
  >
    ...
    <span className="text-sm text-muted-foreground block">Deploy your app to production</span>
  </a>
</div>

## Source Code

[Download Complete Source Code](https://github.com/nextellarlabs/nextellar-examples/tree/main/payment-app)
